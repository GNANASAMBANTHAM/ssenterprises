...
<body>
	...
	<!-- header -->
	<div class="top-header-area" id="sticker" class="fixed-top d-flex align-items-center header-transparent">
		<div class="container">
			<div class="row">
                ...
                <div class="col-md-12">
                    <div class="product-filters">
                        <ul>
                            ...
                            <li data-filter=".strawberry">Cotton Waste</li>
                            <li data-filter=".berry">Rayon Waste</li>
                            <li data-filter=".lemon">Vest Waste</li>
							<li data-filter=".yarn">Cotton Yarn</li>
                        </ul>
						<i class="bi bi-list mobile-nav-toggle"></i>
                    </div>
                </div>
		...
		<div class="col-sm-6 col-md-4 col-lg-3 mb-2">
			...
			<div class="card p-2 mb-2">
				...
				<form action="" class="form-submit">
					...
					<a href="login.php" class="cart-btn addItemBtn"><i class="fas fa-shopping-cart"></i> Add to Cart</a>
					<br>
					<br>
								...
								<div class="container">
									<div class="row">
										...
										<div class="contact-form-box">
											<h4>Shop Address</h4>
											<p>152 Muthusamy Street<br> kottai <br> Erode-1</p>
										</div>
										<div class="contact-form-box">
											<h4> Shop Hours</h4>
										...
										<div class="contact-form-box">
											<h4> Contact</h4>
											<p>Phone: +91 9345852636 <br> Email: ssenterprises@gmail.com</p>
										</div>
									</div>
								</div>
						</div>
